        ...
        <>
          ...
          <div className="bg-gray-800 h-[60vh] overflow-y-auto p-4 rounded-lg mb-4">
            {chatList.map((chat) => (
              ...
              >
                ...
                >
                  <p className="text-sm font-bold mb-1">{chat.name}</p>
          ...
          <form onSubmit={sendMessage} className="flex gap-2 w-full">
            <input
              ...
              className="flex-1 min-w-0 bg-gray-800 px-4 py-2 rounded-lg outline-none"
            />
            <button
              type="submit"
              className="px-5 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg shrink-0"
            >
              Kirim
            </button>
          </form>
