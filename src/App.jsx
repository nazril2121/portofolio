        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/nazrilabizar.png" className="w-10 rounded-md" />
              <q>im just to be a better person</q>
            </div>
...
Aku tidak sekadar membuat visual; aku merancang rasa, membangun atmosfer, dan menghadirkan pengalaman estetika yang bisa dirasakan. Setiap karya adalah perjalanan, setiap detail membawa makna, dan setiap goresan menjadi narasi yang ingin tinggal lebih lama dalam ingatan mereka yang melihatnya."
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              ...
              >
                <ShinyText text="Download portofolio" disabled={false} speed={3} className="custom-class" />
              </a>
  ...
  <ProfileCard
    ...
    handle="abizarsocrates"
    status="Online"
    contactText={
      <a 
        href="https://www.instagram.com/abizarsocrates/" 
        target="_blank" 
    ...
    avatarUrl="./assets/nazrilabizar.png"
    showUserInfo={true}
    enableTilt={true}
    ...
    <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
      ...
      <div className="flex-1 text-left">
        ...
        <div className="tools mt-32">
          <h1 className="text-4xl/snug font-bold mb-4" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" >Core Skills & Tools</h1>
          <p className="w-2/5 text-base/loose opacity-50" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true">Software & technologies I’m experienced with.</p>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/nazrilabz@gmail.com"
                method="POST"
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="message" className="font-semibold">Kirim Pesan Langsung Pada Saya</label>
                    <textarea
                      name="message"
                      id="message"
                      cols="45"
